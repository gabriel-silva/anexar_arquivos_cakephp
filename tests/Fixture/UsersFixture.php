...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'user_image' => ['type' => 'index', 'columns' => ['image'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'user_image' => ['type' => 'foreign', 'columns' => ['image'], 'references' => ['files', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'image' => 1,
            'created' => '2017-11-13 22:28:49',
            'modified' => '2017-11-13 22:28:49'
        ],
    ];
}
